...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table align="center" class="style4" dir="ltr" style="border-style: ridge; background-color: #FF99FF">
        <tr>
            <td style="width: 1261px; height: 57px;">
        ...
        <tr>
            <td style="width: 1261px; height: 52px;">
        ...
        <tr>
            <td class="style6" style="width: 1261px; background-color: #FF99FF">
        ...
        <tr>
            <td style="width: 1261px; height: 46px;">
        ...
        <tr>
            <td style="width: 1261px; height: 45px;">
        ...
        <tr>
            <td style="width: 1261px; height: 41px;">
        ...
        <tr>
            <td class="style5" style="height: 242px; width: 1261px; background-image: url('etudes_de_droit1.jpg');"
                ...
                <asp:GridView ID="GridView1" runat="server" BackColor="White"
                    ...
                    Style="margin-top: 2px" AllowSorting="True">
                    <Columns>
